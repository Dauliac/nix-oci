...
See [`nixosConfig`](../reference/flake-parts-options.md) in the container module option reference.
...
- [Container module options](../reference/flake-parts-options.md): full reference for `nixosConfig`, `mainService`, and all per-container options
