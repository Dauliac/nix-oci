          ...
          fn =
            ...
            pkgs.writeShellApplication {
              ...
              text = ''
                ...
                echo "    image:  $REF"
                echo "    digest: $DIGEST"
                echo "NIX_OCI_PUSHED_TMP arch=${arch} ref=$REF digest=$DIGEST"
              '';
            };
        };
          ...
          fn =
            ...
            pkgs.writeShellApplication {
              ...
              text = ''
                ...
                # tags by counting `NIX_OCI_PUSHED_TAG` lines.
                ...
                # migrate to NIX_OCI_PUSHED_TAG / NIX_OCI_PUSHED.
                echo "NIX_OCI_PUBLISHED ref=$PRIMARY_REF digest=$DIGEST architectures=${lib.concatStringsSep "," arches}"
                ...
                ${lib.concatMapStrings (tag: ''
                  ...
                  echo "NIX_OCI_PUBLISHED ref=$BASE_NAME:${tag} digest=$DIGEST architectures=${lib.concatStringsSep "," arches}"
                '') additionalTags}
